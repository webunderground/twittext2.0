  ...
  <body>
    ...
    <div class="feed">
      ...
      <div class="tweetBox">
        ...
        <button  class="tweetBox__tweetButton" type="file" name="image">select </button>
         <button name="action"  type="submit" name="submit"  class="tweetBox__tweetButton" value="UPLOAD"/>UPLOAD</button> 
